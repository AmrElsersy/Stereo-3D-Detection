...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', type=str, default='predictions/sfa.pickle', help='path of loading 3D bboxes predicitons')
    parser.add_argument('--save_path', type=str, default='eval_mAP/sfa.txt', help='file path to save the evaluation results')
