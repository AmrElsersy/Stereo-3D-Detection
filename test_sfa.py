...
from Models.SFA.data_process.kitti_dataloader import create_test_dataloader
from Models.SFA.models.model_utils import create_model
...
from Models.SFA.data_process.transformation import lidar_to_camera_box
from Models.SFA.utils.visualization_utils import merge_rgb_to_bev, show_rgb_image_with_boxes
from Models.SFA.data_process.kitti_data_utils import Calibration
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        for batch_idx, batch_data in enumerate(test_dataloader):
            ...
            if len(kitti_dets) > 0:
                kitti_dets[:, 1:-1] = lidar_to_camera_box(kitti_dets[:, 1:-1], calib.V2C, calib.R0, calib.P2)
