...
def dataloader(filepath, train_spit=None, val_list=None, load_npy=False):
    ...
    left_train_disp = [os.path.join(filepath, 'training', disp_L, img + extintion) for img in train]
    ...
    left_val_disp = [os.path.join(filepath, 'training', disp_L, img + extintion) for img in val]
