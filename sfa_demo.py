...
def parse_test_configs(parser = None):
    ...
    parser.add_argument('--pretrained_path', type=str, default='configs/checkpoints/sfa.pth', metavar='PATH')
    ...
    parser.add_argument('--pretrained', type=str, default='configs/checkpoints/anynet.tar',help='pretrained model path')
